  ...
  return (
    <>
      <div className="fixed inset-0 bg-black/70 backdrop-opacity-95 backdrop-blur-md z-40 flex items-center justify-center">
        <div className="relative flex flex-col items-center max-w-lg gap-6 px-6 py-8 rounded-xl shadow-xl bg-(--accent) z-50">
          <button 
            className="absolute top-4 right-4 hover:text-(--secondary-dark)"
            onClick={onClose}
          >
